...
<?php 
	...
	echo form_open_multipart('proportionates/submit/'.$update_id);
?>
	<legend for="proportionate_name">Candidate Name: </legend>
	<input name="proportionate_name" value="<?php echo $proportionate_name; ?>" /><br/><br/>
